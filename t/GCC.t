...
is(
    &getCommand(), "g++ -Wall -Wextra -Werror -Wcast-align -Wcast-qual -Wconversion -pedantic -std=c++11 t/Mockups/fake1.cpp t/Mockups/fake2.cpp -o a.out",
...
&addDebugFlags();
is(
    &getCommand(), "g++ -Wall -Wextra -Werror -Wcast-align -Wcast-qual -Wconversion -pedantic -std=c++11 -lglut -lm -lGL -lGLU -ggdb -g3 t/Mockups/fake2.cpp t/Mockups/fake1.cpp -o a.out",
